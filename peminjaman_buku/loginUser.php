...
<body>
  ...
  <?php 
  if ( isset($_POST['daftar']) ) {
    $dataSiswaBaru = query("SELECT * FROM siswa ORDER BY idKelas DESC LIMIT 1")[0];
  ?>

  <form action="user.php" method="post" class="m-auto my-5 p-3 rounded-5">
    <div class="d-flex justify-content-center m-0">
      <img src="assets/images/SMKN 1 Cirebon.png" alt="">
    </div>

    <h2 class="text-center pb-3">Login Siswa</h2>

    <div class="mb-3 px-3 mt-5">
      <label for="nama" class="form-label">Nama :</label>
      <input type="text" name="nama" class="form-control border-0 border-bottom" id="nama" aria-describedby="emailHelp" value="<?= $dataSiswaBaru['namaSiswa'] ?>" >
    </div>
    ...
    <div class="mb-3 px-3">
      ...
      <input type="number" name="kontak" class="form-control border-0 border-bottom" 
      id="kontak" value="<?= $dataSiswaBaru['kontakSiswa'] ?>">
    </div>
